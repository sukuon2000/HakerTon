		...
		<div class="text-6-mian bottom-space py-5">
			<div class="container py-md-5 py-4">
				...
				<div class="waviy text-center mb-sm-5 mb-4 pb-lg-4">
					<span>당신의 <span style="color: #ff0000;">취향 분석 결과</span>를
						알려드려요!
					</span>
				...
				<div class="row top-cont-grid align-items-center">
					<div class="col-lg-3 right-img sec-img-ab mb-5">
						<a href="#">
							<h4 class="mt-3" style="color: #fff">카페 산토리니</h4> <img
							src="${pageContext.request.contextPath}/assets/images/event1.jpg"
				...
				<div>
					...
					<a href="#" class="btn btn-style mt-4 col-lg-4"
						style="text-align: center;"
						onclick="javascript:confirm('저장하였습니다!')">분석결과를 데이터 베이스에
						저장하시겠습니까?</a>
					<div class="col-lg-4"></div>
				</div>
				<br>
